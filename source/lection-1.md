...
\begin{aligned} X_{i}, Y_{i} \end{aligned} - логические выражения
\begin{aligned} D_{i} \end{aligned} - фактор достоверности (0, 1) или фактор уверенности (0, 100)
...
Нечеткое подмножество `N` множества `M`:

\begin{aligned}
N = { \mu_{N}(x)/x }
\end{aligned}
\begin{aligned} \mu_{N}(x) \end{aligned} - характеристическая фукнция принадлежности [0, 1]
