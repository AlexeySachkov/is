...
\begin X_{i}, Y_{i} \end - логические выражения
\begin D_{i} \end - фактор достоверности (0, 1) или фактор уверенности (0, 100)
...
N = { \mu_{N}(x)/x }
\end{aligned}
\begin \mu_{N}(x) \end - характеристическая фукнция принадлежности [0, 1]
